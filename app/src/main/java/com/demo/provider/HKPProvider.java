...
import com.demo.provider.base.BaseContentProvider;
import com.demo.provider.message.MessageColumns;

public class HKPProvider extends BaseContentProvider {
    private static final String TAG = HKPProvider.class.getSimpleName();
    ...
    private static final int URI_TYPE_MESSAGE = 0;
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return HKPSQLiteOpenHelper.getInstance(getContext());
    }
